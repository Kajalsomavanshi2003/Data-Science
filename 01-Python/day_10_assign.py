...
for i in users:
    if i=='Admin':
        ...
        print("Hello Staff")
##############################################################
current_users=['avi','yash','Kajal','sanket','aniket']
new_users=['avi','kumar','krishna','Kajal','yash']
for i in new_users:
...
#############################################################
import hashlib
hashlib.sha256("Kajal@321".encode('utf-8')).hexdigest()
len(hashlib.sha256("Kajal@321".encode('utf-8')).digest())
